...
def smooth_l1(sigma=3.0, sigma_var=None):
    ...
    def _smooth_l1(y_true, y_pred):
        ...
        regression_loss = backend.where(
            ...
            factor * 0.5 * sigma_squared * keras.backend.pow(regression_diff, 2) + keras.backend.log(sigma_var),
            np.sqrt(2) * (regression_diff - 0.5 / sigma_squared) / sigma_var + keras.backend.log(sigma_var) - 0.5
        )
