...
def parse_args(args):
    ...
    parser.add_argument('--save-path',        help='Path for saving bboxes with detections (doesn\'t work for COCO).')
    parser.add_argument("--save-path-image",  help='Path for saving images with detections (doesn\'t work for COCO).')
